...
(function($)
{
	...
	$.fn.advancedSearchField.defaults = {
		 ...
		 * @var string
		 */
		tipFocus: 'Digite sua pesquisa',
		
		/**
		 * Message is search is too short
		 * @var string
		 */
		tipTooShort: 'Digite ao menos 2 letras',
		
		/**
		 * Message while loading
		 * @var string
		 */
		messageLoading: 'Carregando resultados...',
		
		/**
		 * Message when no matches found
		 * @var string
		 */
		messageNoMatches: 'Sem resultados',
		
		/**
		 * Message when the search request is done
		 * @var string
		 */
		messageSearchDone: 'TOTAL ',
		
		/**
		 * Full message if an error occurs while loading results
		 * @var string
		 */
		messageErrorFull: 'Erro ao carregar dados. Tente novamente',
		
		/**
		 * Status message if an error occurs while loading results
		 * @var string
		 */
		messageError: 'Erro ao carregar',
